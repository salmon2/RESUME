...
```“실패에서 배우면 성공이 된다”는 실패에도 배움이 있다는 자세로 끊임없이 공부하고 있습니다.```
...
## 프로젝트
<img src="https://user-images.githubusercontent.com/23234577/144531606-3f50649e-982d-4a33-88b4-51558b4f4273.png" width = 360 height = 200px/>
...
-	전반적인 도메인 설계와 구현
-	전반적인 API 설계
-	Querydsl 라이브러리를 통한 동적 쿼리 처리 -> 코드 재사용성과 유지보수성 증가
-	Open API와 스케줄링 프로그래밍을 통한 최신 기상 데이터 확보 -> 추천 서비스의 신뢰성 확보
-	무중단 배포 환경 구축 -> 서버 안정성 확보
-	https 통신 환경 구축 -> 서버 보안 확보
-	모니터링 서버 구축
